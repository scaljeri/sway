...
_yuitest_coverage["./src/data/field.js"].lines = {"1":0,"2":0,"4":0,"5":0,"84":0,"85":0,"86":0,"88":0,"89":0,"91":0,"92":0,"94":0,"98":0,"99":0,"102":0,"113":0,"114":0,"117":0,"125":0,"128":0,"129":0,"130":0,"131":0,"132":0,"136":0,"138":0,"151":0,"152":0,"153":0,"156":0,"160":0};
_yuitest_coverage["./src/data/field.js"].functions = {"Field:84":0,"set:98":0,"transform:112":0,"validate:124":0,"isField:137":0,"transform:151":0,"(anonymous 1):4":0};
_yuitest_coverage["./src/data/field.js"].coveredLines = 31;
...
function set(key, value) {
        _yuitest_coverfunc("./src/data/field.js", "set", 98);
_yuitest_coverline("./src/data/field.js", 99);
this[key] = value ;
    }

    _yuitest_coverline("./src/data/field.js", 102);
Field.prototype = {
        ...
        transform: function (value, callback) {
            _yuitest_coverfunc("./src/data/field.js", "transform", 112);
_yuitest_coverline("./src/data/field.js", 113);
if (this.transformers) {
                _yuitest_coverline("./src/data/field.js", 114);
transform(0, this.transformers, callback, value);
            }
            else {
                _yuitest_coverline("./src/data/field.js", 117);
callback(value);
            }
        }
        /**
         ...
         */, validate: function (value) {
            _yuitest_coverfunc("./src/data/field.js", "validate", 124);
_yuitest_coverline("./src/data/field.js", 125);
var i
                , ok = true;

            _yuitest_coverline("./src/data/field.js", 128);
if (this.validators) {
...
break;
            ...
            _yuitest_coverline("./src/data/field.js", 136);
return ok;
        }, isField: function () {
            _yuitest_coverfunc("./src/data/field.js", "isField", 137);
_yuitest_coverline("./src/data/field.js", 138);
return true;
        }
        /*
         * Returns the size of
    ...
    _yuitest_coverline("./src/data/field.js", 151);
function transform(index, transformers, callback, value) {
        _yuitest_coverfunc("./src/data/field.js", "transform", 151);
...
transformers[index].transform(value, transform.bind(null, ++index, transformers, callback));
            ...
            _yuitest_coverline("./src/data/field.js", 156);
callback(value);
        }
    }

    _yuitest_coverline("./src/data/field.js", 160);
ns.Field = Field;
