...
this.model = model;
        ...
        _yuitest_coverline("./src/data/relation.js", 80);
switch (type) {
            case 'belongs_to' :
...
this.set = options.through ? setHasOneThrough.bind(this) : setHasOne.bind(this) ;
                _yuitest_coverline("./src/data/relation.js", 86);
break ;
            case 'has_many':
...
break;
            default:
                _yuitest_coverline("./src/data/relation.js", 94);
this.set = function(){ _yuitest_coverfunc("./src/data/relation.js", "set", 94);
...
return Object.freeze(this);
    ...
    _yuitest_coverline("./src/data/relation.js", 100);
Relation.prototype = {} ;
...
function setBelongsTo(self, key, value) {
        _yuitest_coverfunc("./src/data/relation.js", "setBelongsTo", 105);
...
self.__data[key] = value ;
            ...
            _yuitest_coverline("./src/data/relation.js", 111);
...
function setHasMany(data, value) {
    ...
    _yuitest_coverline("./src/data/relation.js", 125);
function setHasManyThrough(data, value) {
    }
    _yuitest_coverline("./src/data/relation.js", 127);
function setHasAndBelongsToMany(data, value) {
    }

    _yuitest_coverline("./src/data/relation.js", 130);
