...
function canAddCallback(callbacks, callback, options) {
        _yuitest_coverfunc("./src/eventhub.js", "canAddCallback", 308);
...
return retVal ;
     ...
     */
    _yuitest_coverline("./src/eventhub.js", 333);
function checkInput(eventName, callback) {
        _yuitest_coverfunc("./src/eventhub.js", "checkInput", 333);
...
retVal = true ;
        ...
        else {_yuitest_coverline("./src/eventhub.js", 338);
if ( ns.DEBUG ) { // Wrong...
...
console.warn("Cannot bind the callback function to the event nam ( eventName=" + eventName + ",  callback=" + callback + ")") ;
        ...
        _yuitest_coverline("./src/eventhub.js", 341);
return retVal ;
    }
...
function removeFromNamespace(namespaces, callback, options) {
            _yuitest_coverfunc("./src/eventhub.js", "removeFromNamespace", 349);
...
retVal += removeCallback(namespace.on, callback, options) ;
            ...
            else {_yuitest_coverline("./src/eventhub.js", 359);
...
return retVal ;                                             // a count of removed callback function
     ...
     */
    _yuitest_coverline("./src/eventhub.js", 369);
function removeCallback(list, callback, options){
        _yuitest_coverfunc("./src/eventhub.js", "removeCallback", 369);
...
return retVal ;
     ...
     */
    _yuitest_coverline("./src/eventhub.js", 386);
function getStack(namespace) {
        _yuitest_coverfunc("./src/eventhub.js", "getStack", 386);
...
var parts = namespace ? namespace.split('.') : []   // parts of the event namespaces
        ...
        _yuitest_coverline("./src/eventhub.js", 391);
...
stack = stack[parts[i]] ;                       // traverse a level deeper into the stack
        ...
        _yuitest_coverline("./src/eventhub.js", 397);
...
function createStack(namespace) {
        _yuitest_coverfunc("./src/eventhub.js", "createStack", 407);
...
var parts = namespace.split('.')                    // split the namespace
        ...
        _yuitest_coverline("./src/eventhub.js", 412);
...
function triggerEventCapture(eventName, data) {
        _yuitest_coverfunc("./src/eventhub.js", "triggerEventCapture", 427);
...
var i
        ...
        _yuitest_coverline("./src/eventhub.js", 434);
if ( parts.length > 1 ) {
...
function triggerEventBubble(namespace, data) {
        ...
        _yuitest_coverfunc("./src/eventhub.js", "triggerEventBubble", 443);
...
retVal += callCallbacks(namespace, data, eventMode) ;
        ...
        _yuitest_coverline("./src/eventhub.js", 452);
return retVal ;
    }
...
function triggerEvent(stack, data, options) {
        _yuitest_coverfunc("./src/eventhub.js", "triggerEvent", 459);
_yuitest_coverline("./src/eventhub.js", 460);
var  retVal = 0
            , ns ;                                                  // loop index

        _yuitest_coverline("./src/eventhub.js", 463);
for( ns in stack ) {
...
retVal += callCallbacks(stack, data) ;
           ...
           else {_yuitest_coverline("./src/eventhub.js", 467);
...
retVal += triggerEvent(stack[ns], data, options) ;  // nested namespaces. NOTE that the 'eventName' is omitted!!
        ...
        _yuitest_coverline("./src/eventhub.js", 471);
return retVal ;
    }
...
function callCallbacks(namespace, data, eventMode) {
        _yuitest_coverfunc("./src/eventhub.js", "callCallbacks", 482);
...
namespace.__stack.on.splice(i--, 1) ;               // remove callback for index is i, and afterwards fix loop index with i--
        ...
        _yuitest_coverline("./src/eventhub.js", 497);
return retVal ;
    }
