...
_yuitest_coverage["./src/persistance/fs.js"] = {
    lines: {},
    functions: {},
    coveredLines: 0,
    calledLines: 0,
...
console.log('File: ' + entry.fullPath);}}
		...
		file: function(filename, path) {
			_yuitest_coverfunc("./src/persistance/fs.js", "file", 41);
_yuitest_coverline("./src/persistance/fs.js", 42);
var self = this ;
			_yuitest_coverline("./src/persistance/fs.js", 43);
return {
				write:  function(content, callback) { _yuitest_coverfunc("./src/persistance/fs.js", "write", 44);
_yuitest_coverline("./src/persistance/fs.js", 44);
self.writeFile(content, filename, path, callback); },
				read:   function(callback) { _yuitest_coverfunc("./src/persistance/fs.js", "read", 45);
_yuitest_coverline("./src/persistance/fs.js", 45);
self.readFile(filename, path, callback); },
				append: function(content, callback) {},
				exists: function(callback) { _yuitest_coverfunc("./src/persistance/fs.js", "exists", 47);
_yuitest_coverline("./src/persistance/fs.js", 47);
self.fileExists(filename, path, callback); },
				remove: function(callback) { _yuitest_coverfunc("./src/persistance/fs.js", "remove", 48);
_yuitest_coverline("./src/persistance/fs.js", 48);
...
fileEntry.createWriter(successCallback, opt_errorCallback);
		*/
		writeFile: function(content, filename, path, callback, options) {
			_yuitest_coverfunc("./src/persistance/fs.js", "writeFile", 70);
_yuitest_coverline("./src/persistance/fs.js", 71);
requestFileSystem(window[this._storageType], this._storageSize*1024*1024 /*5MB*/, function(fs) {
				_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 5)", 71);
_yuitest_coverline("./src/persistance/fs.js", 72);
fs.root.getFile([path, filename].join('/'), {create: true, exclusive: false}, function(fileEntry) {
  					_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 6)", 72);
_yuitest_coverline("./src/persistance/fs.js", 73);
fileEntry.createWriter(function(fileWriter) {
    						_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 7)", 73);
_yuitest_coverline("./src/persistance/fs.js", 74);
var bb = new Blob([content], {type : "text/plain"});
						_yuitest_coverline("./src/persistance/fs.js", 75);
fileWriter.onwrite = callback ;
    						_yuitest_coverline("./src/persistance/fs.js", 76);
fileWriter.write(bb); 
  					}, errorHandler);
				}, errorHandler);
			}, errorHandler) ;
		...
		appendFile: function(content, filename, path, callback) {
			_yuitest_coverfunc("./src/persistance/fs.js", "appendFile", 81);
_yuitest_coverline("./src/persistance/fs.js", 82);
this.writeFile(content, filename, path, callback, { append: true }) ;
		...
		*/
		readFile: function(filename, path, callback) {
			_yuitest_coverfunc("./src/persistance/fs.js", "readFile", 87);
_yuitest_coverline("./src/persistance/fs.js", 88);
requestFileSystem(window[this._storageType], this._storageSize*1024*1024 /*5MB*/, function(fs) {
				_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 8)", 88);
_yuitest_coverline("./src/persistance/fs.js", 89);
fs.root.getFile([path, filename].join(''), {}, function(fileEntry) {
    				_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 9)", 89);
_yuitest_coverline("./src/persistance/fs.js", 90);
fileEntry.file(function(file) {
					    _yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 10)", 90);
_yuitest_coverline("./src/persistance/fs.js", 91);
if ( file.type == "text/plain" ) {
       						_yuitest_coverline("./src/persistance/fs.js", 92);
var reader = new FileReader();
       						_yuitest_coverline("./src/persistance/fs.js", 93);
reader.onloadend = function(e) {
							    _yuitest_coverfunc("./src/persistance/fs.js", "onloadend", 93);
_yuitest_coverline("./src/persistance/fs.js", 94);
callback(e.target.result) ;
						    }
       						_yuitest_coverline("./src/persistance/fs.js", 96);
reader.readAsText(file);
					    }
					    else
						    {_yuitest_coverline("./src/persistance/fs.js", 99);
callback(file) ;}
    				}, errorHandler);
  				}, errorHandler)
  			}, errorHandler);
		...
		fileExists: function(filename, path, callback) {
			_yuitest_coverfunc("./src/persistance/fs.js", "fileExists", 104);
_yuitest_coverline("./src/persistance/fs.js", 105);
requestFileSystem(window[this._storageType], this._storageSize*1024*1024 /*5MB*/, function(fs) {
				_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 11)", 105);
_yuitest_coverline("./src/persistance/fs.js", 106);
fs.root.getFile([path, filename].join('/'), {create: true}, function(fileEntry) {
        			_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 12)", 106);
_yuitest_coverline("./src/persistance/fs.js", 107);
fileEntry.file(function(file) {
            				_yuitest_coverfunc("./src/persistance/fs.js", "(anonymous 13)", 107);
_yuitest_coverline("./src/persistance/fs.js", 108);
var reader = new FileReader();
            				_yuitest_coverline("./src/persistance/fs.js", 109);
reader.onloadend = function() {
                				// The file exists and is readable
						_yuitest_coverfunc("./src/persistance/fs.js", "onloadend", 109);
_yuitest_coverline("./src/persistance/fs.js", 111);
callback(true) ;
            				};
            				_yuitest_coverline("./src/persistance/fs.js", 113);
reader.readAsText(file);
        			}, errorHandler);
    			}, errorHandler);
			}, errorHandler) ;
...
*/
	...
	**/
	_yuitest_coverline("./src/persistance/fs.js", 172);
function errorHandler(e) {
  		_yuitest_coverfunc("./src/persistance/fs.js", "errorHandler", 172);
_yuitest_coverline("./src/persistance/fs.js", 173);
var msg = '';
			
  		_yuitest_coverline("./src/persistance/fs.js", 175);
switch (e.code) {
    			case FileError.QUOTA_EXCEEDED_ERR:
      				_yuitest_coverline("./src/persistance/fs.js", 177);
msg = 'QUOTA_EXCEEDED_ERR';
      				_yuitest_coverline("./src/persistance/fs.js", 178);
break;
    			case FileError.NOT_FOUND_ERR:
      				_yuitest_coverline("./src/persistance/fs.js", 180);
msg = 'NOT_FOUND_ERR';
      				_yuitest_coverline("./src/persistance/fs.js", 181);
break;
    			case FileError.SECURITY_ERR:
      				_yuitest_coverline("./src/persistance/fs.js", 183);
msg = 'SECURITY_ERR';
      				_yuitest_coverline("./src/persistance/fs.js", 184);
break;
    			case FileError.INVALID_MODIFICATION_ERR:
      				_yuitest_coverline("./src/persistance/fs.js", 186);
msg = 'INVALID_MODIFICATION_ERR';
      				_yuitest_coverline("./src/persistance/fs.js", 187);
break;
    			case FileError.INVALID_STATE_ERR:
      				_yuitest_coverline("./src/persistance/fs.js", 189);
msg = 'INVALID_STATE_ERR';
      				_yuitest_coverline("./src/persistance/fs.js", 190);
break;
    			default:
      				_yuitest_coverline("./src/persistance/fs.js", 192);
msg = 'Unknown Error';
      				_yuitest_coverline("./src/persistance/fs.js", 193);
break;
  		}_yuitest_coverline("./src/persistance/fs.js", 194);
;
	
  		_yuitest_coverline("./src/persistance/fs.js", 196);
console.error('Error: ' + msg);
	}

	_yuitest_coverline("./src/persistance/fs.js", 199);
Ns.Fs = fs ;
})(window.Sway) ;
